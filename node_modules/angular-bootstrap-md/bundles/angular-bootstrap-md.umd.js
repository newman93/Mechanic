(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('rxjs/operators'), require('rxjs'), require('@angular/animations'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('angular-bootstrap-md', ['exports', '@angular/core', '@angular/common', '@angular/forms', 'rxjs/operators', 'rxjs', '@angular/animations', '@angular/router'], factory) :
    (global = global || self, factory(global['angular-bootstrap-md'] = {}, global.ng.core, global.ng.common, global.ng.forms, global.rxjs.operators, global.rxjs, global.ng.animations, global.ng.router));
}(this, (function (exports, core, common, forms, operators, rxjs, animations, router) { 'use strict';
